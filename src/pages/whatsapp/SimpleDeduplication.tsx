// Simple Deduplication Page - Working Version
// صفحة إزالة التكرار المبسطة - نسخة تعمل فعلياً
...
const mockContacts = [
  { id: 1, name: 'أحمد محمد', phone: '0123456789', email: 'ahmed@example.com', source: 'whatsapp' },
  { id: 2, name: 'أحمد محمد', phone: '0123456789', email: 'ahmed@example.com', source: 'brokers' },
  { id: 3, name: 'أحمد محمد', phone: '0123456789', email: 'ahmed@example.com', source: 'clients' },
  { id: 4, name: 'فاطمة علي', phone: '0987654321', email: 'fatima@example.com', source: 'whatsapp' },
  { id: 5, name: 'فاطمة علي', phone: '0987654321', email: 'fatima@example.com', source: 'owners' },
  { id: 6, name: 'محمد أحمد', phone: '0555555555', email: 'mohamed@example.com', source: 'whatsapp' },
  { id: 7, name: 'محمد أحمد', phone: '0555555555', email: 'mohamed@example.com', source: 'tenants' },
  { id: 8, name: 'علي حسن', phone: '0666666666', email: 'ali@example.com', source: 'whatsapp' },
  { id: 9, name: 'علي حسن', phone: '0666666666', email: 'ali@example.com', source: 'brokers' },
  { id: 10, name: 'سارة أحمد', phone: '0777777777', email: 'sara@example.com', source: 'whatsapp' }
];

export default function SimpleDeduplication() {
  ...
  const findDuplicateContacts = (contactsList: any[]) => {
    ...
    return Object.values(groups)
      ...
      .map(group => ({
        ...
        contacts: group,
        count: group.length,
        priority: group.length >= 3 ? 'high' : group.length === 2 ? 'medium' : 'low'
      }));
  };
  ...
  const mergeDuplicateContacts = (contactsList: any[], duplicatesList: any[]) => {
    ...
    duplicatesList.forEach(duplicate => {
      // الاحتفاظ بالجهة الأولى (WhatsApp) وحذف الباقي
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-3 text-2xl">
            ...
            إزالة التكرار المبسطة - تعمل فعلياً
          </CardTitle>
          <p className="text-gray-600 text-lg">
            نظام مبسط لإزالة التكرار في جهات الاتصال مع محاكاة عملية حقيقية
          </p>
        </CardHeader>
      </Card>
        ...
        <Card className="border-green-200 bg-green-50">
          ...
          <CardContent>
            ...
            <div className="mt-4 text-center text-sm text-green-600">
              ...
              تم في: {new Date(results.timestamp).toLocaleString('ar-SA')}
            </div>
          </CardContent>
        </Card>
      )}

      {/* قائمة جهات الاتصال الحالية */}
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
