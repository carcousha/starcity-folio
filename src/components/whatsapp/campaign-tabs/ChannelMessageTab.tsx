// Channel Message Tab Component
// مكون تاب رسالة القناة
...
export const ChannelMessageTab: React.FC<ChannelMessageTabProps> = ({ 
  data, 
  onChange, 
  isLoading 
}) => {
  return (
    <div className="space-y-6">
      <div className="text-right">
        <h2 className="text-2xl font-bold text-gray-900 mb-2">رسالة القناة</h2>
        <p className="text-gray-600">إنشاء رسالة من قناة</p>
      </div>
