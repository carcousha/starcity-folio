-- مزامنة البيانات الموجودة مع الأعمدة الصحيحة
CREATE OR REPLACE FUNCTION sync_existing_data_correct()
RETURNS void
LANGUAGE plpgsql
SECURITY DEFINER
AS $$
...
BEGIN
  ...
  -- مزامنة الوسطاء (استخدام office_name بدلاً من company)
  INSERT INTO public.enhanced_contacts (
    name,
    phone,
    email,
...
-- تشغيل المزامنة
SELECT sync_existing_data_correct();