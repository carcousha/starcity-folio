-- تعطيل audit trigger مؤقتاً للمصروفات
ALTER TABLE public.expenses DISABLE TRIGGER audit_trigger;
...
-- إعادة تفعيل audit trigger
ALTER TABLE public.expenses ENABLE TRIGGER audit_trigger;