...
-- إزالة policy إذا كان موجود وإعادة إنشاؤه
DROP POLICY IF EXISTS "Admins and accountants can manage rental contracts" ON public.rental_contracts;
...
DROP POLICY IF EXISTS "Users can view relevant rental contracts" ON public.rental_contracts;
...
DROP POLICY IF EXISTS "All users can view workflow stages" ON public.government_service_workflow;
