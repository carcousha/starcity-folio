...
CREATE TABLE public.whatsapp_templates (
  ...
  name TEXT NOT NULL,
  description TEXT,
  message_type TEXT NOT NULL CHECK (message_type IN ('text', 'media', 'button', 'list', 'poll')),
  content JSONB NOT NULL, -- محتوى القالب
  variables JSONB DEFAULT '[]'::jsonb, -- المتغيرات القابلة للتخصيص
