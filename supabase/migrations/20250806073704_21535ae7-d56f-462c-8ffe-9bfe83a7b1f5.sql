-- حذف القيد نهائياً 
ALTER TABLE public.expenses DROP CONSTRAINT personal_expense_requires_employee;

-- إنشاء قيد جديد يدعم المديونيات
ALTER TABLE public.expenses 
ADD CONSTRAINT personal_expense_requires_employee 
CHECK (expense_type != 'personal' OR recorded_by IS NOT NULL);

-- الآن إنشاء مصروفات للمديونيات الموجودة
DO $$
DECLARE
  debt_record RECORD;
  expense_id_var UUID;
