-- إصلاح الحقول المفقودة في جدول enhanced_contacts
-- يمكن تشغيل هذا الملف مباشرة في لوحة تحكم Supabase

-- إضافة حقول العقارات والاستثمار المطلوبة
...
-- تحديث جميع السجلات الموجودة لتحديث search_vector
